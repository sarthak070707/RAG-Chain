...
def run_rag_chain(query):
    ...
    # Invoke the Chain
    response = rag_chain.invoke({"context": format_docs(docs), "question": query})

    with open("logs.json", "a") as f:
        json.dump({"query": query, "response": str(response)}, f)
        f.write("\n")
...
def main():
    ...
    # Sidebar Footer
    st.sidebar.write("Built with ❤️ by [Sarthak Arya](https://www.linkedin.com/in/sarthak-arya-059920303/)")
